...
; 26   : void DrawTile(Tile tile, int color[]) {
...
; 27   : 	DrawRect(tile.position, tile.width, tile.height, color);
...
_TEXT	SEGMENT
_tile$2 = -96						; size = 4
_<end>$L0$3 = -84					; size = 12
_<begin>$L0$4 = -64					; size = 12
_<range>$L0$5 = -44					; size = 4
_color$ = -32						; size = 12
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
...
; 31   : 	int color[3] = { 0, 0, 255 };

	mov	DWORD PTR _color$[ebp], 0
	mov	DWORD PTR _color$[ebp+4], 0
	mov	DWORD PTR _color$[ebp+8], 255		; 000000ffH

; 32   : 	for (auto &tile : tileMap) {

	mov	DWORD PTR _<range>$L0$5[ebp], OFFSET ?tileMap@@3V?$vector@UTile@@V?$allocator@UTile@@@std@@@std@@A ; tileMap
	push	12					; 0000000cH
	...
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	push	12					; 0000000cH
	lea	ecx, DWORD PTR _<end>$L0$3[ebp]
	call	?__autoclassinit2@?$_Vector_iterator@V?$_Vector_val@U?$_Simple_types@UTile@@@std@@@std@@@std@@QAEXI@Z
...
; 33   : 		if (tile.tileID == 1) { color[0] = 0; color[1] = 0; color[2] = 255; }

	mov	eax, DWORD PTR _tile$2[ebp]
	cmp	DWORD PTR [eax+24], 1
	jne	SHORT $LN5@DrawMap
	mov	eax, 4
	imul	ecx, eax, 0
...
; 34   : 		if (tile.tileID == 5) { color[0] = 255; color[1] = 0; color[2] = 0; }

	mov	eax, DWORD PTR _tile$2[ebp]
	cmp	DWORD PTR [eax+24], 5
	jne	SHORT $LN6@DrawMap
	mov	eax, 4
	imul	ecx, eax, 0
...
; 35   : 		if (tile.tileID == 6) { color[0] = 255; color[1] = 0; color[2] = 255; }

	mov	eax, DWORD PTR _tile$2[ebp]
	cmp	DWORD PTR [eax+24], 6
	jne	SHORT $LN7@DrawMap
	mov	eax, 4
	imul	ecx, eax, 0
	mov	DWORD PTR _color$[ebp+ecx], 255		; 000000ffH
	mov	eax, 4
...
; 36   : 		if (tile.tileID == 7) { color[0] = 255; color[1] = 0; color[2] = 255; }
...
; 39   : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN17@DrawMap
	call	@_RTC_CheckStackVars@8
	pop	eax
	pop	edx
	mov	ecx, DWORD PTR __$EHRec$[ebp]
...
$T7 = -360						; size = 16
$T8 = -336						; size = 16
_tempPushTile$9 = -120					; size = 48
_tempTile$10 = -64					; size = 32
_x$11 = -24						; size = 4
_y$12 = -12						; size = 4
__$ArrayPad$ = -4					; size = 4
?GenerateTileMap@@YAXXZ PROC				; GenerateTileMap, COMDAT

; 8    : void GenerateTileMap() {
...
$LN4@GenerateTi:
	cmp	DWORD PTR _y$12[ebp], 60		; 0000003cH
	jge	$LN3@GenerateTi

; 10   : 		for (int x = 0; x < MAPSIZEX; x++) {
...
$LN7@GenerateTi:
	cmp	DWORD PTR _x$11[ebp], 80		; 00000050H
	jge	$LN6@GenerateTi

; 11   : 			Tile tempTile;

	lea	ecx, DWORD PTR _tempTile$10[ebp]
	call	??0Tile@@QAE@XZ

; 12   : 			PushTile tempPushTile;

	lea	ecx, DWORD PTR _tempPushTile$9[ebp]
	call	??0PushTile@@QAE@XZ

; 13   : 
; 14   : 			if (tileMapGrid[y][x] == 1) { tempTile.position = Vector2(x * tempTile.width, y * tempTile.height); tempTile.tileID = 1; tileMap.push_back(tempTile); }

	imul	eax, DWORD PTR _y$12[ebp], 320
	mov	ecx, DWORD PTR _x$11[ebp]
	cmp	DWORD PTR ?tileMapGrid@@3PAY0FA@HA[eax+ecx*4], 1
	jne	SHORT $LN8@GenerateTi
	mov	eax, DWORD PTR _y$12[ebp]
	imul	eax, DWORD PTR _tempTile$10[ebp+20]
	cvtsi2sd xmm0, eax
	sub	esp, 8
	movsd	QWORD PTR [esp], xmm0
	mov	ecx, DWORD PTR _x$11[ebp]
	imul	ecx, DWORD PTR _tempTile$10[ebp+16]
	cvtsi2sd xmm0, ecx
	sub	esp, 8
	movsd	QWORD PTR [esp], xmm0
	...
	mov	edx, DWORD PTR [eax]
	mov	DWORD PTR _tempTile$10[ebp], edx
	mov	ecx, DWORD PTR [eax+4]
	mov	DWORD PTR _tempTile$10[ebp+4], ecx
	mov	edx, DWORD PTR [eax+8]
	mov	DWORD PTR _tempTile$10[ebp+8], edx
	mov	eax, DWORD PTR [eax+12]
	mov	DWORD PTR _tempTile$10[ebp+12], eax
	mov	DWORD PTR _tempTile$10[ebp+24], 1
	lea	eax, DWORD PTR _tempTile$10[ebp]
	push	eax
	mov	ecx, OFFSET ?tileMap@@3V?$vector@UTile@@V?$allocator@UTile@@@std@@@std@@A ; tileMap
	call	?push_back@?$vector@UTile@@V?$allocator@UTile@@@std@@@std@@QAEXABUTile@@@Z ; std::vector<Tile,std::allocator<Tile> >::push_back
$LN8@GenerateTi:

; 15   : 			if (tileMapGrid[y][x] == 2) { tempPushTile.tile.position = Vector2(x * tempPushTile.tile.width, y * tempPushTile.tile.height); tempPushTile.tile.tileID = 2; tempPushTile.end = false; pushTileMap.push_back(tempPushTile); }
	...
	mov	eax, DWORD PTR _y$12[ebp]
	imul	eax, DWORD PTR _tempPushTile$9[ebp+20]
	cvtsi2sd xmm0, eax
	sub	esp, 8
	movsd	QWORD PTR [esp], xmm0
	mov	ecx, DWORD PTR _x$11[ebp]
	imul	ecx, DWORD PTR _tempPushTile$9[ebp+16]
	cvtsi2sd xmm0, ecx
	sub	esp, 8
	movsd	QWORD PTR [esp], xmm0
	...
	call	??0Vector2@@QAE@NN@Z			; Vector2::Vector2
	mov	edx, DWORD PTR [eax]
	mov	DWORD PTR _tempPushTile$9[ebp], edx
	mov	ecx, DWORD PTR [eax+4]
	mov	DWORD PTR _tempPushTile$9[ebp+4], ecx
	mov	edx, DWORD PTR [eax+8]
	mov	DWORD PTR _tempPushTile$9[ebp+8], edx
	mov	eax, DWORD PTR [eax+12]
	mov	DWORD PTR _tempPushTile$9[ebp+12], eax
	mov	DWORD PTR _tempPushTile$9[ebp+24], 2
	mov	BYTE PTR _tempPushTile$9[ebp+44], 0
	lea	eax, DWORD PTR _tempPushTile$9[ebp]
	push	eax
	mov	ecx, OFFSET ?pushTileMap@@3V?$vector@UPushTile@@V?$allocator@UPushTile@@@std@@@std@@A ; pushTileMap
...
; 16   : 			if (tileMapGrid[y][x] == 3) { tempPushTile.tile.position = Vector2(x * tempPushTile.tile.width, y * tempPushTile.tile.height); tempPushTile.tile.tileID = 2; tempPushTile.end = true; pushTileMap.push_back(tempPushTile); }
	...
	mov	DWORD PTR _tempPushTile$9[ebp+12], eax
	mov	DWORD PTR _tempPushTile$9[ebp+24], 2
	mov	BYTE PTR _tempPushTile$9[ebp+44], 1
	lea	eax, DWORD PTR _tempPushTile$9[ebp]
	push	eax
	mov	ecx, OFFSET ?pushTileMap@@3V?$vector@UPushTile@@V?$allocator@UPushTile@@@std@@@std@@A ; pushTileMap
	call	?push_back@?$vector@UPushTile@@V?$allocator@UPushTile@@@std@@@std@@QAEXABUPushTile@@@Z ; std::vector<PushTile,std::allocator<PushTile> >::push_back
...
; 17   : 			if (tileMapGrid[y][x] == 4) { spawnTile.position = Vector2(x * spawnTile.width, y * spawnTile.height); spawnTile.tileID = 4; }
...
; 18   : 			if (tileMapGrid[y][x] == 5) { tempTile.position = Vector2(x * tempTile.width, y * tempTile.height); tempTile.tileID = 5; tileMap.push_back(tempTile); }
	...
	mov	eax, DWORD PTR [eax+12]
	mov	DWORD PTR _tempTile$10[ebp+12], eax
	mov	DWORD PTR _tempTile$10[ebp+24], 5
	lea	eax, DWORD PTR _tempTile$10[ebp]
	push	eax
	mov	ecx, OFFSET ?tileMap@@3V?$vector@UTile@@V?$allocator@UTile@@@std@@@std@@A ; tileMap
	call	?push_back@?$vector@UTile@@V?$allocator@UTile@@@std@@@std@@QAEXABUTile@@@Z ; std::vector<Tile,std::allocator<Tile> >::push_back
...
; 19   : 			if (tileMapGrid[y][x] == 6) { tempTile.position = Vector2(x * tempTile.width, (y * tempTile.height) + 5); tempTile.tileID = 6; tempTile.height = 5; tileMap.push_back(tempTile); }
	...
	mov	eax, DWORD PTR [eax+12]
	mov	DWORD PTR _tempTile$10[ebp+12], eax
	mov	DWORD PTR _tempTile$10[ebp+24], 6
	mov	DWORD PTR _tempTile$10[ebp+20], 5
	lea	eax, DWORD PTR _tempTile$10[ebp]
	push	eax
	mov	ecx, OFFSET ?tileMap@@3V?$vector@UTile@@V?$allocator@UTile@@@std@@@std@@A ; tileMap
	call	?push_back@?$vector@UTile@@V?$allocator@UTile@@@std@@@std@@QAEXABUTile@@@Z ; std::vector<Tile,std::allocator<Tile> >::push_back
...
; 20   : 			if (tileMapGrid[y][x] == 7) { tempTile.position = Vector2(x * tempTile.width, (y * tempTile.height) + 5); tempTile.tileID = 7; tempTile.height = 5; tileMap.push_back(tempTile); }
	...
	mov	eax, DWORD PTR [eax+12]
	mov	DWORD PTR _tempTile$10[ebp+12], eax
	mov	DWORD PTR _tempTile$10[ebp+24], 7
	mov	DWORD PTR _tempTile$10[ebp+20], 5
	lea	eax, DWORD PTR _tempTile$10[ebp]
	push	eax
	mov	ecx, OFFSET ?tileMap@@3V?$vector@UTile@@V?$allocator@UTile@@@std@@@std@@A ; tileMap
...
; 21   : 			if (tileMapGrid[y][x] == 8) { tempTile.position = Vector2(x * tempTile.width, y * tempTile.height); tempTile.tileID = 7; tempTile.height = 5; tileMap.push_back(tempTile); }
...
; 24   : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN20@GenerateTi
	call	@_RTC_CheckStackVars@8
	pop	eax
	pop	edx
	pop	edi
